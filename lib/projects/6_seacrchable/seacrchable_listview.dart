...
class SeacrchableApp extends StatefulWidget {
  const SeacrchableApp({Key? key}) : super(key: key);

  @override
  _SeacrchableAppState createState() => _SeacrchableAppState();
}

class _SeacrchableAppState extends State<SeacrchableApp> {
